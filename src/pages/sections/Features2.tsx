...
const Features2 = () => {
    ...
    const { item } = feature;
    return (
        <section className='section min-h-[600px]' id='feature'>
            <div className='container mx-auto pt-[128px] '>
                <div className='flex flex-col lg:flex-row lg:gap-x-14 justify-between'>
                    <div className='lg:order-1  lg:w-[50%] flex flex-1 flex-col justify-end text-justify gap-y-4 lg:justify-start mb-8 lg:mb-0'>
